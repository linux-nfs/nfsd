...
#define show_nfs4_ace4_access_type(x) \
	__print_symbolic(x, \
		{ NFS4_ACE_ACCESS_ALLOWED_ACE_TYPE,		"ACCESS_ALLOWED" }, \
		{ NFS4_ACE_ACCESS_DENIED_ACE_TYPE,		"ACCESS_DENIED" }, \
		{ NFS4_ACE_SYSTEM_AUDIT_ACE_TYPE,		"SYSTEM_AUDIT" }, \
		{ NFS4_ACE_SYSTEM_ALARM_ACE_TYPE,		"SYSTEM_ALARM" })

#define show_nfs4_ace4_flags(x) \
	__print_flags(x, "|", \
		{ NFS4_ACE_FILE_INHERIT_ACE,		"FILE_INHERIT" }, \
		{ NFS4_ACE_DIRECTORY_INHERIT_ACE,	"DIR_INHERIT" }, \
		{ NFS4_ACE_NO_PROPAGATE_INHERIT_ACE,	"NO_PROPOGATE_INHERIT" }, \
		{ NFS4_ACE_INHERIT_ONLY_ACE,		"INHEREIT_ONLY" }, \
		{ NFS4_ACE_SUCCESSFUL_ACCESS_ACE_FLAG,	"SUCCESSFUL_ACCESS" }, \
		{ NFS4_ACE_FAILED_ACCESS_ACE_FLAG,	"FAILED_ACCESS" }, \
		{ NFS4_ACE_IDENTIFIER_GROUP,		"IDENTIFIER_GROUP" }, \
		{ NFS4_ACE_INHERITED_ACE,		"INHERITED" })

#define show_nfs4_ace4_access_mask(x) \
	__print_flags(x, "|", \
		{ NFS4_ACE_READ_DATA,			"READ_DATA" }, \
		{ NFS4_ACE_LIST_DIRECTORY,		"LIST_DIRECTORY" }, \
		{ NFS4_ACE_WRITE_DATA,			"WRITE_DATA" }, \
		{ NFS4_ACE_ADD_FILE,			"ADD_FILE" }, \
		{ NFS4_ACE_APPEND_DATA,			"APPEND_DATA" }, \
		{ NFS4_ACE_ADD_SUBDIRECTORY,		"ADD_SUBDIRECTORY" }, \
		...
		{ NFS4_ACE_WRITE_RETENTION,		"WRITE_RETENTION" }, \
		{ NFS4_ACE_WRITE_RETENTION_HOLD,	"WRITE_RETENTION_HOLD" }, \
...
TRACE_DEFINE_ENUM(NFS4_OPEN_DELEGATE_NONE);
TRACE_DEFINE_ENUM(NFS4_OPEN_DELEGATE_READ);
TRACE_DEFINE_ENUM(NFS4_OPEN_DELEGATE_WRITE);
TRACE_DEFINE_ENUM(NFS4_OPEN_DELEGATE_NONE_EXT);

#define show_nfs4_delegation_type(x) \
	__print_symbolic(x, \
		{ NFS4_OPEN_DELEGATE_NONE,		"NONE" }, \
		{ NFS4_OPEN_DELEGATE_READ,		"READ" }, \
		{ NFS4_OPEN_DELEGATE_WRITE,		"WRITE" }, \
		{ NFS4_OPEN_DELEGATE_NONE_EXT,		"NONE_EXT" })

#define show_nfs4_open_result(x) \
	__print_flags(x, "|", \
		{ NFS4_OPEN_RESULT_CONFIRM,		"CONFIRM" }, \
		{ NFS4_OPEN_RESULT_LOCKTYPE_POSIX,	"LOCKTYPE_POSIX" }, \
		{ NFS4_OPEN_RESULT_PRESERVE_UNLINKED,	"PRESERVE_UNLINKED" }, \
		{ NFS4_OPEN_RESULT_MAY_NOTIFY_LOCK,	"MAY_NOTIFY_LOCK" })
...
TRACE_DEFINE_ENUM(LAYOUT_NFSV4_1_FILES);
TRACE_DEFINE_ENUM(LAYOUT_OSD2_OBJECTS);
TRACE_DEFINE_ENUM(LAYOUT_BLOCK_VOLUME);
TRACE_DEFINE_ENUM(LAYOUT_FLEX_FILES);
TRACE_DEFINE_ENUM(LAYOUT_SCSI);

#define show_pnfs_layout_type(x) \
	__print_symbolic(x, \
		{ LAYOUT_NFSV4_1_FILES,		"NFSV1_FILES" }, \
		{ LAYOUT_OSD2_OBJECTS,		"OSD2_OBJECTS" }, \
		{ LAYOUT_BLOCK_VOLUME,		"BLOCK_VOLUME" }, \
...
#define show_nfs4_data_content(x) \
	__print_symbolic(x, \
		{ NFS4_CONTENT_DATA,		"DATA" }, \
		{ NFS4_CONTENT_HOLE,		"HOLE" })

TRACE_DEFINE_ENUM(WND4_NOT_WANTED);
TRACE_DEFINE_ENUM(WND4_CONTENTION);
TRACE_DEFINE_ENUM(WND4_RESOURCE);
TRACE_DEFINE_ENUM(WND4_NOT_SUPP_FTYPE);
TRACE_DEFINE_ENUM(WND4_WRITE_DELEG_NOT_SUPP_FTYPE);
TRACE_DEFINE_ENUM(WND4_NOT_SUPP_UPGRADE);
TRACE_DEFINE_ENUM(WND4_NOT_SUPP_DOWNGRADE);
TRACE_DEFINE_ENUM(WND4_CANCELLED);
TRACE_DEFINE_ENUM(WND4_IS_DIR);

#define show_nfs4_why_no_delegation(x) \
	__print_symbolic(x, \
		{ WND4_NOT_WANTED,		"NOT_WANTED" }, \
		{ WND4_CONTENTION,		"CONTENTION" }, \
		{ WND4_RESOURCE,		"RESOURCE" }, \
		{ WND4_NOT_SUPP_FTYPE,		"NOT_SUPP_FTYPE" }, \
		{ WND4_WRITE_DELEG_NOT_SUPP_FTYPE, "WRITE_DELEG_NOT_SUPP_FTYPE" }, \
		{ WND4_NOT_SUPP_UPGRADE,	"NOT_SUPP_UPGRADE" }, \
		{ WND4_NOT_SUPP_DOWNGRADE,	"NOT_SUPP_DOWNGRADE" }, \
		{ WND4_CANCELLED,		"CANCELLED" }, \
		{ WND4_IS_DIR,			"IS_DIR" })
